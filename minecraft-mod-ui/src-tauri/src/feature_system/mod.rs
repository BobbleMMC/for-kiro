...
pub fn all_features() -> Vec<FeatureInfo> {
    ...
    vec![
        ...
        FeatureInfo {
            ...
            notes: "Skeleton emits a TieredItem subclass with TODOs for Tier definition and breakable-block tag.".into(),
        },
        FeatureInfo {
            kind: Armor,
            name: "Armor".into(),
            ...
            command_name: None,
            editor_panel_id: None,
            notes: "Skeleton emits an ArmorItem subclass per slot with a custom ArmorMaterial TODO.".into(),
        },
        FeatureInfo {
            kind: Food,
            name: "Food".into(),
            ...
            command_name: None,
            editor_panel_id: None,
            notes: "Skeleton emits an Item with FoodProperties.Builder; effect application TODO.".into(),
        },
        FeatureInfo {
            kind: Enchantment,
            ...
            notes: "Editor exists but values are not persisted to DB yet, and there is no Java codegen.".into(),
        },
        ...
        FeatureInfo {
            ...
            notes: "Editor with full attribute / drop / spawn UI exists but does not persist or generate Java yet.".into(),
        },
        FeatureInfo {
        ...
        FeatureInfo {
            ...
            notes: "Editor present (BiomeEditor) but no persistence or codegen yet.".into(),
        },
        FeatureInfo {
            kind: Dimension,
            name: "Dimension".into(),
            ...
            notes: "Editor present (DimensionEditor) but no persistence or codegen yet.".into(),
        },
        FeatureInfo {
        ...
        FeatureInfo {
            ...
            notes: "Editor has 3x3 grid + smelting cook-time UI but does not persist or emit JSON yet.".into(),
        },
        FeatureInfo {
            kind: LootTable,
        ...
        FeatureInfo {
            ...
            notes: "Editor present; persistence / JSON codegen TODO.".into(),
        },
